document.addEventListener('DOMContentLoaded', function contentLoaded() {
    ...
    var init = function() {
        ...
        getRecording(0).then(
            function(error, recording) {
                currentRecording = recording;

                getRecording(1).then(function(error, recording) {
    ...
    var prepareNextRecording = function() {
        ...
        recordingIndex = currentRecording.index === totalRecordings ? currentRecording.index : currentRecording.index + 1;
    ...
    var preparePreviousRecording = function() {
        ...
        recordingIndex = currentRecording.index === 0 ? 0 : currentRecording.index - 1;
    ...
    var updateBackgroundImages = function() {
        ...
        if (currentPosition > previousPosition && currentPosition >= nextRecording.dom.getPosition()[1])
